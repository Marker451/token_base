...
// BatchTransfer is a paid mutator transaction binding the contract method 0x83f12fec.
//
// Solidity: function batchTransfer(_receivers address[], _value uint256) returns(bool)
func (_Token *TokenTransactor) BatchTransfer(opts *bind.TransactOpts, _receivers []common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "batchTransfer", _receivers, _value)
}

// BatchTransfer is a paid mutator transaction binding the contract method 0x83f12fec.
//
// Solidity: function batchTransfer(_receivers address[], _value uint256) returns(bool)
func (_Token *TokenSession) BatchTransfer(_receivers []common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Token.Contract.BatchTransfer(&_Token.TransactOpts, _receivers, _value)
}

// BatchTransfer is a paid mutator transaction binding the contract method 0x83f12fec.
//
// Solidity: function batchTransfer(_receivers address[], _value uint256) returns(bool)
func (_Token *TokenTransactorSession) BatchTransfer(_receivers []common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Token.Contract.BatchTransfer(&_Token.TransactOpts, _receivers, _value)
}
